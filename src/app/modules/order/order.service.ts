  ...
  if (payload.paymentMethod === 'sslCommerz') {
    ...
    try {
      const paymentResponse = await SSLCommerzService.initiatePayment({
        ...
        success_url: `https://book-shop-server-rosy.vercel.app/api/order/pay-success/${transactionId}`,
        fail_url: `https://book-shop-server-rosy.vercel.app/api/order/pay-fail/${transactionId}`,
        cancel_url: `https://book-shop-server-rosy.vercel.app/api/order/pay-cancel/${transactionId}`,
